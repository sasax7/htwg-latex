...
\begin{itemize}
  ...
  \item A hierarchical root-cause attribution pipeline grounded in building ontologies and causal dependencies.
	\item A domain-specific multivariate benchmark dataset generated via \ac{BOPTEST} with labeled contextual fault scenarios (see Section~\ref{sec:benchmark-design}).

...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\textwidth]{images/feature-improtance.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\textwidth]{images/anomaly-dataset-examples.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{images/mdn-dense-cnn-baseline-comparison.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{images/mdn-dense-cnn-baseline-comparison-mainmeter.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{images/chronos-vs-cnnmdn.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.7\textwidth]{images/sesonal-distance.png}
